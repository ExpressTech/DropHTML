...
/*jshint -W083 */
	...
	$.jstree.core.prototype = {
		...
		init : function (el, options) {
			...
			this.element.html("<"+"ul class='jstree-container-ul jstree-children' role='group'><"+"li id='j"+this._id+"_loading' class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='treeitem'><i class='jstree-icon jstree-ocl'></i>"+ this.get_string("Loading ...") + "</li></ul>");
		...
		_create_prototype_node : function () {
			...
			/*_temp2.className = 'jstree-anchor';*/
			_temp2.className = '';
		...
		bind : function () {
			...
			this.element
				...
				.on("click.jstree", ".folder-node .jstree-anchor .folder-name", $.proxy(function (e) {
						if(e.target.tagName && e.target.tagName.toLowerCase() === "input") { return true; }
      ...
      if (obj && $.inArray(obj.id, this._model.changed) === -1) {
		...
		refresh : function (skip_loading, forget_state) {
			...
			if(!skip_loading) {
				this.element.html("<"+"ul class='"+c+"' role='group'><"+"li class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='treeitem' id='j"+this._id+"_loading'>"+ this.get_string("Loading ...") + "</li></ul>");
				this.element.attr('aria-activedescendant','j'+this._id+'_loading');
			}
